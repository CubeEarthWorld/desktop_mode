package com.xignal.external_touchpad.service
...
import com.xignal.external_touchpad.MainActivity
import com.xignal.external_touchpad.R

private const val NOTIFICATION_CHANNEL_ID = "external_touchpad_monitor"
...
class DisplayMonitorService : Service() {
    ...
    private fun launchTouchpad() {
        try {
            ...
            ExternalTouchpadController.getInstance(applicationContext)
