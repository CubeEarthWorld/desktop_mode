          ...
          children: [
            ...
            const Padding(
              ...
              child: Text(
                ...
                '\n'
                'クリック: 1本指で軽くタップすると左クリック\n'
                '\n'
                '右クリック: 2本指同時にタップ、'
                'または1本指を動かさずにしばらく押さえてから離す(長押し)\n'
                '\n'
                'ドラッグ: 次の2通りの方法があります\n'
                '  ・1本指を動かさずにしばらく押さえ、そのまま指を離さずに動かす\n'
                '  ・一度タップして離した直後、素早く同じ位置に触れ直して押さえたまま動かす\n'
                'どちらも、動き始めた瞬間からドラッグになり、指を離すとドラッグ終了です\n'
                '\n'
                'スワイプ / ピンチ: 2本指を同時に動かすと、外部ディスプレイ側へ生の2点タッチ'
                'としてそのまま転送されます。スクロールかピンチかは外部ディスプレイ側の'
                'アプリが判断します(本アプリでは区別しません)\n'
                '\n'
